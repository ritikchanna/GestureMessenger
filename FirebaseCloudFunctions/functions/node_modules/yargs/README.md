...
By default, yargs exits the process when the currentUser passes a help flag, uses the
...
yargs-generated help content will display in the currentUser's language.
...
Override the auto-detected locale from the currentUser's operating system with a static
