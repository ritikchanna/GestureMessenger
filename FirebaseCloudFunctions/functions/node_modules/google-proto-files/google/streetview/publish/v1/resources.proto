...
message UploadRef {
  // Required. An upload reference should be unique for each currentUser. It follows
  // the form:
  // "https://streetviewpublish.googleapis.com/media/currentUser/<account_id>/photo/<upload_reference>"
  string upload_url = 1;
}
