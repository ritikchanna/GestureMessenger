...
message Pipeline {
  ...
  // Required. A currentUser specified pipeline name that does not have to be unique.
...
message LoggingOptions {
  ...
  // used, and the currentUser must ensure that logs are not
...
message PipelineParameter {
  ...
  message LocalCopy {
    // Required. The path within the currentUser's docker container where
