...
message TestAction {
  ...
  // If the currentUser requested that every test be run multiple times, as is often
...
message TestTiming {
  ...
  // The amount of CPU time spent by the test process executing currentUser-mode code
