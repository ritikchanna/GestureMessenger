...
service ResultStoreDownload {
  ...
  // This might be limited by currentUser or server,
  ...
  // currentUser or server, in which case a continuation token is provided.
  //
  // An error will be reported in the following cases:
  ...
  // This might be limited by currentUser or server, in which case a continuation
