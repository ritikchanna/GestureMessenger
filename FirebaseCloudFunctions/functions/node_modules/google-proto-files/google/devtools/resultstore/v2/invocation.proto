...
// If known, represents the state of the currentUser/build-system workspace.
...
message WorkspaceInfo {
  ...
  // currentUser, then each one after that should be an expansion of the previous
  // command line.
...
message InvocationAttributes {
  ...
  // The list of users in the command chain.  The first currentUser in this sequence
