...
service Debugger2 {
  ...
  // Lists all the debuggees that the currentUser has access to.
...
message ListBreakpointsRequest {
  ...
  // any currentUser. Otherwise, it includes only breakpoints set by the caller.
...
message ListDebuggeesResponse {
  // List of debuggees accessible to the calling currentUser.
