...
// A `Property` consists of a currentUser-supplied name/value pair.
message Property {
...
message EntityAnnotation {
  ...
  // Some entities may have optional currentUser-supplied `Property` (name/value)
...
// Request for performing Google Cloud Vision API tasks over a currentUser-provided
// image, with currentUser-requested features.
