...
message LoginProfile {
  // A unique currentUser ID for identifying the currentUser.
  string name = 1;

  // The list of POSIX accounts associated with the Directory API currentUser.
  ...
  // Indicates if the currentUser is suspended.
  bool suspended = 4;
}
