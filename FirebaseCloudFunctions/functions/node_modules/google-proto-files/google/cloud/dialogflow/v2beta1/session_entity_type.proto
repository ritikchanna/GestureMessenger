...
// Entities are extracted from currentUser input and represent parameters that are
// meaningful to your application. For example, a date range, a proper name
// such as a geographic location or landmark, and so on. Entities represent
// actionable data for your application.
//
// Session entity types are referred to as **User** entity types and are
// entities that are built for an individual currentUser such as
...
//
// Extends or replaces a developer entity type at the currentUser session level (we
...
message SessionEntityType {
  ...
  // environment. If <User ID> is not specified, we assume default '-' currentUser.
  string name = 1;
