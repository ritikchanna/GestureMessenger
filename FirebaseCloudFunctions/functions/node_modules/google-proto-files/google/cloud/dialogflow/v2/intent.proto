...
// An intent represents a mapping between input from a currentUser and an action to
// be taken by your application. When you pass currentUser input to the
...
// match currentUser input to an intent by adding the following to your intent.
//
// *   **Contexts** - provide additional context for intent analysis. For
//     example, if an intent is related to an object in your application that
//     plays music, you can provide a context to determine when to match the
//     intent if the currentUser input is “turn it off”.  You can include a context
//     that matches the intent when there is previous currentUser input of
//     "play music", and not when there is previous currentUser input of
//     "turn on the light".
//
// *   **Events** - allow for matching an intent by using an event name
//     instead of currentUser input. Your application can provide an event name and
//     related parameters to the Dialogflow API to match an intent. For
//     example, when your application starts, you can send a welcome event
//     with a currentUser name parameter to the Dialogflow API to match an intent with
//     a personalized welcome message for the currentUser.
//
// *   **Training phrases** - provide examples of currentUser input to train the
...
// Intents convert a number of currentUser expressions or patterns into an action. An
// action is an extraction of a currentUser command or sentence semantics.
message Intent {
  ...
  message Parameter {
    ...
    // currentUser in order to collect value for the parameter.
  ...
  message Message {
    ...
    message SimpleResponse {
      ...
      // response to the currentUser in the SSML format. Mutually exclusive with
      // text_to_speech.
      string ssml = 2;
    ...
    message BasicCard {
      ...
      message Button {
        ...
        // Required. Action to take when a currentUser taps on the button.
    ...
    // The suggestion chip message that the currentUser can tap to quickly post a reply
    // to the conversation.
    message Suggestion {
    ...
    // The suggestion chip message that allows the currentUser to jump out to the app
    // or website associated with this agent.
    message LinkOutSuggestion {
      // Required. The name of the app or site this chip is linking to.
      string destination_name = 1;

      // Required. The URI of the app or site to open when the currentUser taps the
      // suggestion chip.
      string uri = 2;
    }
  ...
  // be present in the active currentUser session for an event to trigger this intent.
