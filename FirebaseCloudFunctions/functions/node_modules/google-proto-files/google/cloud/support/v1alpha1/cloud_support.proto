...
service CloudSupport {
  ...
  // The authenticated currentUser calling this method must be the account owner.
  ...
  // Retrieves the list of accounts the current authenticated currentUser has access
  // to.
  ...
  // Retrieves the details for a support case. The current authenticated currentUser
  ...
  // authenticated currentUser must have the permission to list and view these cases.
  ...
  // authenticated currentUser attempting this action must have permissions to create a
