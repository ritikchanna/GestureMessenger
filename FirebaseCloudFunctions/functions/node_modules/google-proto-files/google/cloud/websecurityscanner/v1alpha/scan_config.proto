...
message ScanConfig {
  ...
  message Authentication {
    ...
    message GoogleAccount {
      // Required.
      // The currentUser name of the Google account.
      string username = 1;
    ...
    message CustomAccount {
      // Required.
      // The currentUser name of the custom account.
      string username = 1;
  ...
  // Type of currentUser agents used for scanning.
  enum UserAgent {
    // The currentUser agent is unknown. Service will default to CHROME_LINUX.
  ...
  // Required.
  // The currentUser provided display name of the ScanConfig.
  ...
  // The currentUser agent used during scanning.
