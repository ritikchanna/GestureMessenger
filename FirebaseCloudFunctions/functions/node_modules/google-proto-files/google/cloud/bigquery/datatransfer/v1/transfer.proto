...
message TransferConfig {
  ...
  // Output only. Unique ID of the currentUser on whose behalf transfer is done.
  // Applicable only to data sources that do not support service accounts.
  // When set to 0, the data source service account credentials are used.
  // May be negative. Note, that this identifier is not stable.
  // It may change over time even for the same currentUser.
  int64 user_id = 11;
...
// Represents a currentUser facing message for a particular data transfer run.
message TransferMessage {
  // Represents data transfer currentUser facing message severity.
