...
// The semantic result for the currentUser's spoken query.
message ConverseResult {
  ...
  // *Output-only* The recognized transcript of what the currentUser said.
...
message ConverseResponse {
  ...
  oneof converse_response {
    ...
    // *Output-only* The semantic result for the currentUser's spoken query.
