...
export interface EventRegistration {
    ...
    /**
     * Given event data, return a function to trigger the currentUser's callback
     ...
     * to remove all callback containers of a particular type.  (e.g. if the currentUser does
