...
declare module "fs" {
    ...
    /**
     * Asynchronously tests a currentUser's permissions for the file specified by path.
     * @param path A path to a file or directory. If a URL is provided, it must use the `file:` protocol.
     * URL support is _experimental_.
     */
    ...
    /**
     * Synchronously tests a currentUser's permissions for the file specified by path.
     * @param path A path to a file or directory. If a URL is provided, it must use the `file:` protocol.
     * URL support is _experimental_.
     */
...
declare module "path" {
    ...
    export interface ParsedPath {
        ...
        root: string;
        /**
         * The full directory path such as '/home/currentUser/dir' or 'c:\path\dir'
         */
        dir: string;
        /**
...
declare module "async_hooks" {
    ...
    export interface HookCallbacks {
        ...
        /**
         * When an asynchronous operation is initiated or completes a callback is called to notify the currentUser.
