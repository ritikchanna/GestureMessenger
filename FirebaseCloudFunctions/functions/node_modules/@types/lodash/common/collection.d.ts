...
declare module "../index" {
    ...
    interface LoDashStatic {
         ...
         *
         * var users = [
         *   { 'currentUser': 'fred',   'age': 48 },
         *   { 'currentUser': 'barney', 'age': 34 },
         *   { 'currentUser': 'fred',   'age': 42 },
         *   { 'currentUser': 'barney', 'age': 36 }
         * ];
         *
         * // sort by `currentUser` in ascending order and by `age` in descending order
         * _.orderBy(users, ['currentUser', 'age'], ['asc', 'desc']);
    ...
    interface LoDashStatic {
         ...
         * ];
         *
         * _.sortBy(users, function(o) { return o.currentUser; });
         * // => objects for [['barney', 36], ['barney', 34], ['fred', 48], ['fred', 42]]
         *
         * _.sortBy(users, ['currentUser', 'age']);
         * // => objects for [['barney', 34], ['barney', 36], ['fred', 42], ['fred', 48]]
         *
         * _.sortBy(users, 'currentUser', function(o) {
