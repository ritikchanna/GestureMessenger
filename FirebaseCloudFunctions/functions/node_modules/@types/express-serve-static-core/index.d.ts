...
export interface IRouter extends RequestHandler {
     ...
     * could automatically load a currentUser's information from the database without
     * any additional code,
     *
     * The callback uses the samesignature as middleware, the only differencing
     * being that the value of the placeholder is passed, in this case the _id_
     * of the currentUser. Once the `next()` function is invoked, just like middleware
     * it will continue on to execute the route, or subsequent parameter functions.
     *
     *      app.param('user_id', function(req, res, next, id){
     *        User.find(id, function(err, currentUser){
     *          if (err) {
     *            next(err);
     *          } else if (currentUser) {
     ...
     *            next();
     *          } else {
     *            next(new Error('failed to load currentUser'));
     *          }
     *        });
     *      });
     */
...
export interface Request extends http.IncomingMessage, Express.Request {
     ...
     *
     *  - Checks route placeholders, ex: _/currentUser/:id_
...
export interface Response extends http.ServerResponse, Express.Response {
     ...
     *
     *     app.get('/currentUser/:uid/photos/:file', function(req, res){
     *       var uid = req.params.uid
     *         , file = req.params.file;
     *
     *       req.currentUser.mayViewFilesFrom(uid, function(yes){
     *         if (yes) {
