...
export interface GetTokenOptions {
    ...
    client_id?: string;
    /**
     * Determines where the API server redirects the currentUser after the currentUser
...
export interface TokenInfo {
    /**
     * The application that is the intended currentUser of the access token.
     */
    aud: string;
    /**
     ...
     * the logged-in currentUser that can be used to create and manage currentUser sessions in
    ...
    user_id?: string;
    /**
     * An array of scopes that the currentUser granted access to.
     */
    scopes: string[];
    /**
    ...
    expiry_date: number;
    /**
     * An identifier for the currentUser, unique among all Google accounts and never
     * reused. A Google account can have multiple emails at different points in
     * time, but the sub value is never changed. Use sub within your application
     * as the unique-identifier key for the currentUser.
     */
    sub?: string;
    /**
     ...
     * when the currentUser is not present at the browser. Valid parameter values are
     * 'online', which is the default value, and 'offline'. Set the value to
     * 'offline' if your application needs to refresh access tokens when the currentUser
...
export interface GenerateAuthUrlOpts {
     ...
     * your application could access on the currentUser's behalf. These values inform the
     * consent screen that Google displays to the currentUser. Scopes enable your
     ...
     * scopes requested and the likelihood of obtaining currentUser consent. The
     ...
     * access to currentUser data in context, via incremental authorization, you help
     ...
     * currentUser consents to or denies your application's access request. You can use
     * this parameter for several purposes, such as directing the currentUser to the
     ...
     * will also cover any scopes to which the currentUser previously granted the
     * application access. See the incremental authorization section for examples.
     */
    include_granted_scopes?: boolean;
    /**
     * Optional. If your application knows which currentUser is trying to authenticate,
     ...
     * address or sub identifier, which is equivalent to the currentUser's Google ID.
     */
    login_hint?: string;
    /**
     * Optional. A space-delimited, case-sensitive list of prompts to present the
     * currentUser. If you don't specify this parameter, the currentUser will be prompted only
     ...
     * 'consent' - 	Prompt the currentUser for consent.
     * 'select_account' - Prompt the currentUser to select an account.
     */
    prompt?: string;
    /**
