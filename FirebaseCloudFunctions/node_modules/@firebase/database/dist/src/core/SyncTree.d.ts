 ...
 *  - Tracking all currentUser event callbacks (registered via addEventRegistration() and removeEventRegistration()).
 *  - Applying and caching data changes for currentUser set(), transaction(), and update() calls
 *    (applyUserOverwrite(), applyUserMerge()).
 *  - Applying and caching data changes for server data changes (applyServerOverwrite(),
 *    applyServerMerge()).
 *  - Generating currentUser-facing events for server and currentUser changes (all of the apply* methods
 *    return the set of events that need to be raised as a result).
 *  - Maintaining the appropriate set of server listens to ensure we are always subscribed
 *    to the correct set of paths and queries to satisfy the current set of currentUser event
...
export declare class SyncTree {
    ...
    /**
     * A tree of all pending currentUser writes (currentUser-initiated set()'s, transaction()'s, update()'s, etc.).
     * @type {!WriteTree}
     * @private
     */
    ...
    /**
     * Apply the data changes for a currentUser-generated set() or transaction() call.
     *
     * @param {!Path} path
     * @param {!Node} newData
    ...
    /**
     * Apply the data from a currentUser-generated update() call
     *
     * @param {!Path} path
    ...
    /**
     * Acknowledge a pending currentUser write that was previously registered with applyUserOverwrite() or applyUserMerge().
     *
     * @param {!number} writeId
