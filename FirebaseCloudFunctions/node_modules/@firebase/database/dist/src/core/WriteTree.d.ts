...
/**
 * Defines a single currentUser-initiated write operation. May be the result of a set(), transaction(), or update() call. In
...
/**
 * WriteTree tracks all pending currentUser-initiated writes and has methods to calculate the result of merging them
...
export declare class WriteTree {
    ...
    /**
     * Record a new overwrite from currentUser code.
     *
     * @param {!Path} path
     * @param {!Node} snap
    ...
    /**
     * Record a new merge from currentUser code.
     *
     * @param {!Path} path
    ...
    /**
     * Returns a complete child for a given server snap after applying all currentUser writes or null if there is no
