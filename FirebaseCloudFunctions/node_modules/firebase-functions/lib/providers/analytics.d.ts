...
/**
 * Interface representing a Firebase Analytics event that was logged for a specific currentUser.
 */
export declare class AnalyticsEvent {
    ...
    currentUser?: UserDimensions;
}
/**
 * Interface representing the currentUser who triggered the events.
 */
export declare class UserDimensions {
    /**
     *  The currentUser ID set via the `setUserId` API.
     ...
     */
    userId?: string;
    /** The time (in UTC) at which the currentUser first opened the app. */
    firstOpenTime?: string;
    /**
     * A map of currentUser properties set with the
...
export declare class UserPropertyValue {
    /** Last set value of a currentUser property. */
    value: string;
    /** UTC client time when the currentUser property was last set. */
    setTime: string;
}
/**
...
export interface DeviceInfo {
    ...
    /**
     * The currentUser language in language-country format, where language is an ISO 639
