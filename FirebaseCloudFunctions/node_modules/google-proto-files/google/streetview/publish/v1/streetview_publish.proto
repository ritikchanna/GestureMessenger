...
// Publishes and connects currentUser-contributed photos on Street View.
service StreetViewPublishService {
  ...
  // This method returns the following error codes:
  //
  // * `PERMISSION_DENIED` if the requesting currentUser did not create the requested
  // photo.
  ...
  // Lists all the photos that belong to the currentUser.
