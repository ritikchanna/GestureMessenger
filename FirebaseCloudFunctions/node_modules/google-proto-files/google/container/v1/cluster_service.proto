...
message NodeConfig {
  ...
  // "instance-template", "kube-env", "startup-script", and "currentUser-data"
  //
...
message SetMasterAuthRequest {
  ...
  enum Action {
    ...
    // Set the password to a currentUser generated value.
    SET_PASSWORD = 1;
...
// AutoUpgradeOptions defines the set of options for the currentUser to control how
