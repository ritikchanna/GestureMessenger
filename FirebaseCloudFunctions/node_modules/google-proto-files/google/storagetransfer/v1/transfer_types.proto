...
message TransferJob {
  ...
  // A description provided by the currentUser for the job. Its max length is 1024
  ...
  // This field cannot be changed by currentUser requests.
