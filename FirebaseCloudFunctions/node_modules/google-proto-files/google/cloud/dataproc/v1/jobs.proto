...
message SparkJob {
  ...
  // /etc/spark/conf/spark-defaults.conf and classes in currentUser code.
  map<string, string> properties = 7;
...
message HiveJob {
  ...
  // /etc/hive/conf/hive-site.xml, and classes in currentUser code.
...
message PigJob {
  ...
  // Properties that conflict with values set by the Cloud Dataproc API may be
  // overwritten. Can include properties set in /etc/hadoop/conf/*-site.xml,
  // /etc/pig/conf/pig.properties, and classes in currentUser code.
  map<string, string> properties = 5;
...
message JobReference {
  ...
  // is generated by the server upon job submission or provided by the currentUser as a
