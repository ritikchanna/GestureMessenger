...
// A context represents additional information included with currentUser input or with
// an intent returned by the Dialogflow API. Contexts are helpful for
// differentiating currentUser input which may be vague or have a different meaning
// depending on additional details from your application such as currentUser setting
// and preferences, previous currentUser input, where the currentUser is in your application,
...
message ListContextsRequest {
  ...
  // specified, we assume default '-' currentUser.
  string parent = 1;
...
message GetContextRequest {
  ...
  // is not specified, we assume default '-' currentUser.
  string name = 1;
}
