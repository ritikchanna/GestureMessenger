...
// that transform currentUser requests into actionable data. You can include agents
// in your app, product, or service to determine currentUser intent and respond to the
// currentUser in a natural way.
//
...
// manage the flow of a conversation and match currentUser input to predefined intents
// and actions.
//
...
message Agent {
  // Match mode determines how intents are detected from currentUser queries.
  enum MatchMode {
    // Not specified.
  ...
  // Optional. Determines how intents are detected from currentUser queries.
