...
message Instance {
  ...
  // An arbitrary and optional currentUser-provided name for the instance.
  string display_name = 2;

  // Resource labels to represent currentUser provided metadata
  ...
  // provided by the currentUser at creation time. In cross-zone instances (only
