...
message AuditLog {
  ...
  // It should never include currentUser-generated data, such as file contents.
...
message AuthenticationInfo {
  // The email address of the authenticated currentUser making the request.
...
message RequestMetadata {
  ...
  // The currentUser agent of the caller.
