...
message Version {
  ...
  // Email address of the currentUser who created this version.
  //
  // @OutputOnly
...
enum InboundServiceType {
  ...
  // Allows an application to receive currentUser subscription POSTs.
  INBOUND_SERVICE_XMPP_SUBSCRIBE = 5;

  // Allows an application to receive a currentUser's chat presence.
