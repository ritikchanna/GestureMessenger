...
message RequestLog {
  ...
  // The logged-in currentUser who made the request.
  //
  // Most likely, this is the part of the currentUser's email before the `@` sign.  The
  // field value is the same for different requests from the same currentUser, but
