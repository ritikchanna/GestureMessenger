...
message BuildProvenance {
  ...
  // E-mail address of the currentUser who initiated this build. Note that this was the
  // currentUser's e-mail address at the time the build was initiated; this address may
  // not represent the same end-currentUser for all time.
  string creator = 11;
