...
message Breakpoint {
  ...
  // E-mail address of the currentUser that created this breakpoint
  ...
  // display the text message back to the currentUser.
  //
...
message Debuggee {
  ...
  // Human readable message to be displayed to the currentUser about this debuggee.
