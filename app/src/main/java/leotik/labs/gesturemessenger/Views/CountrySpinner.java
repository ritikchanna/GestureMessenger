...
import leotik.labs.gesturemessenger.Adapters.CountryListAdapter;
import leotik.labs.gesturemessenger.POJO.CountryInfo;
import leotik.labs.gesturemessenger.Util.PhoneNumberUtils;

public final class CountrySpinner extends AppCompatEditText implements View.OnClickListener {

    private static final String KEY_SUPER_STATE = "KEY_SUPER_STATE";
    private static final String KEY_COUNTRY_INFO = "KEY_COUNTRY_INFO";

    private final String mTextFormat;
    private final CountrySpinner.DialogPopup mDialogPopup;
    ...
    public CountrySpinner(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDialogPopup = new CountrySpinner.DialogPopup(mCountryListAdapter);
        mTextFormat = "%1$s  +%2$d";
